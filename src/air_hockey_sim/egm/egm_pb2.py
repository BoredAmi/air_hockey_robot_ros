...
_EGMTIMESTAMP = _descriptor.Descriptor(
  name='EgmTimestamp',
  full_name='abb.egm.EgmTimestamp',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='sec', full_name='abb.egm.EgmTimestamp.sec', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='nsec', full_name='abb.egm.EgmTimestamp.nsec', index=1,
...
_EGMPLANNED = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='timeStamp', full_name='abb.egm.EgmPlanned.timeStamp', index=4,
...
_EGMFEEDBACK = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='timeStamp', full_name='abb.egm.EgmFeedBack.timeStamp', index=4,
      number=5, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_EGMMEASUREDFORCE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='fcActive', full_name='abb.egm.EgmMeasuredForce.fcActive', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='force', full_name='abb.egm.EgmMeasuredForce.force', index=1,
...
_EGMCOLLISIONINFO = _descriptor.Descriptor(
  name='EgmCollisionInfo',
  full_name='abb.egm.EgmCollisionInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='collsionTriggered', full_name='abb.egm.EgmCollisionInfo.collsionTriggered', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='collDetQuota', full_name='abb.egm.EgmCollisionInfo.collDetQuota', index=1,
      number=2, type=1, cpp_type=5, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_EGMRAPIDDATA = _descriptor.Descriptor(
  name='EgmRAPIDdata',
  full_name='abb.egm.EgmRAPIDdata',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='digVal', full_name='abb.egm.EgmRAPIDdata.digVal', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='dnum', full_name='abb.egm.EgmRAPIDdata.dnum', index=1,
      number=2, type=1, cpp_type=5, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_EGMROBOT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='moveIndex', full_name='abb.egm.EgmRobot.moveIndex', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='CollisionInfo', full_name='abb.egm.EgmRobot.CollisionInfo', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='RAPIDfromRobot', full_name='abb.egm.EgmRobot.RAPIDfromRobot', index=12,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='torqueRef', full_name='abb.egm.EgmRobot.torqueRef', index=13,
...
_EGMSENSOR = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='RAPIDtoRobot', full_name='abb.egm.EgmSensor.RAPIDtoRobot', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_EGMPLANNED.fields_by_name['timeStamp'].message_type = _EGMTIMESTAMP
...
_EGMFEEDBACK.fields_by_name['timeStamp'].message_type = _EGMTIMESTAMP
...
_EGMROBOT.fields_by_name['CollisionInfo'].message_type = _EGMCOLLISIONINFO
_EGMROBOT.fields_by_name['RAPIDfromRobot'].message_type = _EGMRAPIDDATA
_EGMROBOT.fields_by_name['torqueRef'].message_type = _EGMJOINTS
...
_EGMSENSOR.fields_by_name['RAPIDtoRobot'].message_type = _EGMRAPIDDATA
...
DESCRIPTOR.message_types_by_name['EgmTimestamp'] = _EGMTIMESTAMP
...
DESCRIPTOR.message_types_by_name['EgmCollisionInfo'] = _EGMCOLLISIONINFO
DESCRIPTOR.message_types_by_name['EgmRAPIDdata'] = _EGMRAPIDDATA
...
EgmTimestamp = _reflection.GeneratedProtocolMessageType('EgmTimestamp', (_message.Message,), {
  'DESCRIPTOR' : _EGMTIMESTAMP,
  '__module__' : 'egm_pb2'
  # @@protoc_insertion_point(class_scope:abb.egm.EgmTimestamp)
  })
_sym_db.RegisterMessage(EgmTimestamp)
...
EgmCollisionInfo = _reflection.GeneratedProtocolMessageType('EgmCollisionInfo', (_message.Message,), {
  'DESCRIPTOR' : _EGMCOLLISIONINFO,
  '__module__' : 'egm_pb2'
  # @@protoc_insertion_point(class_scope:abb.egm.EgmCollisionInfo)
  })
_sym_db.RegisterMessage(EgmCollisionInfo)

EgmRAPIDdata = _reflection.GeneratedProtocolMessageType('EgmRAPIDdata', (_message.Message,), {
  'DESCRIPTOR' : _EGMRAPIDDATA,
  '__module__' : 'egm_pb2'
  # @@protoc_insertion_point(class_scope:abb.egm.EgmRAPIDdata)
  })
_sym_db.RegisterMessage(EgmRAPIDdata)
